...
<div class="flex items-center pt-16 h-auto w-full bg-gray-100 px-0 m-auto min-h-screen flex-col">
    ...
    <form method="post" class="w-full h-full" action="{{route('addpost')}}" enctype="multipart/form-data">
             ...
             @error('vacancyImageFiles')
                ...
                @enderror
            <div class="overflow-hidden z-0 relative w-64 mt-4 mb-4 flex">
                ...
                <input class="cursor-pointer absolute block opacity-0 pin-r pin-t h-full w-full" type="file" name="vacancyImageFiles" value="{{old('vacancyImageFiles')}}" >
            ...
            <div class="flex flex-col mt-5">
                ...
                <div class="w-6/12 my-4 h-12 align-middle items-center flex">
                    <input type="text" name="title" value="{{old('title')}}" placeholder="Type the article title here..." class="w-full border border-gray-900 h-full p-2 "/>
                </div>
                @error('title')
                <div class="text-red-500 mt-2 text-sm">
                    {{$message}}
            ...
            <div class="flex flex-col mt-5">
                ...
                <div class="w-6/12 my-4 h-48 align-middle items-center flex">
                    <textarea id="summary_textarea" name="summary" type="text" style="resize:none" class="w-full border border-gray-900 h-full p-2 " placeholder="Type the article summary here...">{{old('summary')}}</textarea>
                </div>
        ...
        <div class="flex flex-col mt-5">
                ...
                <div class="relative flex flex-col my-4 h-auto">
                         ...
                         <trix-editor class="trix-content" input="x">{{old('contents')}}</trix-editor>
